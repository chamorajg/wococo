...
def update_cfg_from_args(env_cfg, cfg_train, args):
    ...
    if env_cfg is not None:
        ...
        if args.apathy is not None:
            if args.apathy:
                env_cfg.rewards.scales.curiosity = 0.0
...
def get_args():
    custom_parameters = [
        ...
        },
        {
            ...
            "action": "store_true",
            "default": False,
            "help": "Use keyboard to control the robot.",
        },
        {
            "name": "--apathy",
            "action": "store_true",
            "default": False,
            "help": "freeze curiosity.",
        },
        {
            "name": "--collision",
            "action": "store_true",
            "default": False,
            "help": "enable self_collision check.",
        },
    ]
    # parse arguments
